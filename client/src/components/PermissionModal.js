    ...
    <div id="defaultModal" tabindex="-1" aria-hidden="true" class="h-modal fixed top-0 right-0 left-0 z-50 flex w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-0 md:h-full">
        <div className="relative h-full w-full max-w-2xl p-4 md:h-auto">
                ...
                <div className="grid grid-cols-2 justify-center px-6">
                    <div className="flex gap-2 flex-col pr-4 pt-4 pb-4 border-r dark:border-gray-600"> 
                        <div className="permission-card"> 
                            <label> @gmail.com </label>
                            <label className="font-bold"> Direct </label>
                        </div>
                        <div className="permission-card"> 
                            <label> @gmail.com </label>
                            <label className="font-bold"> Direct </label>
                    ...
                    <div className="flex flex-col gap-2 items-stretch pl-4 pt-4 pb-4 dark:border-gray-600"> 
                        ...
                        <div className="pt-10 self-center">
                            <button className="rounded-md p-1 px-5 font-bold flex self-center bg-green-500"> Proceed </button>
                        </div>
                    </div>
                </div>
            </div>
