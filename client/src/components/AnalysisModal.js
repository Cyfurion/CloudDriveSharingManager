        ...
        <div  id="defaultModal" tabindex="-1" aria-hidden="true" className="hidden h-modal fixed top-0 right-0 left-0 z-50 w-full overflow-y-auto overflow-x-hidden md:inset-0 md:h-full">
            <div className="relative h-full w-full max-w-2xl p-4 md:h-auto">
                ...
                <div className="space-y-6 p-6">
                    <p className="font-mono text-base leading-relaxed text-gray-500 dark:text-gray-400">Select the type of analysis you would like to perform. Doing so will enable Analysis Mode in the main window. Exit this prompt to cancel Analysis Mode.</p>
                    <div className="grid grid-cols-2 grid-rows-2 gap-x-14 gap-y-8">
